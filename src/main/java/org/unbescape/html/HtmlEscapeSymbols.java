...
final class HtmlEscapeSymbols {
     ...
     * codepoint.
     * Note this cannot be 0, because 0 is a valid index into SORTED_NCRS (e.g. the NCR that sorts first
     * alphabetically, such as "&AElig;", will legitimately be assigned index 0).
     */
