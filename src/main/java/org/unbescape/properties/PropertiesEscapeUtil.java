...
import org.unbescape.java.PropertiesEscapeLevel;
 ...
 *
 */
final class PropertiesEscapeUtil {



    /*
     * JAVA PROPERTIES ESCAPE/UNESCAPE OPERATIONS
     * ------------------------------------------
     *
     ...
     */
    static String escape(final String text, final PropertiesEscapeLevel escapeLevel) {
    ...
    static void escape(final char[] text, final int offset, final int len, final Writer writer,
                       final PropertiesEscapeLevel escapeLevel)
                       throws IOException {
