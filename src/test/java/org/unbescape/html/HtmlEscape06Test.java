 ...
 *
 */
public class HtmlEscape06Test {


    private static final String TEXT_ESC = "Fern&aacutendez";
    private static final String TEXT_UNESC = "Fern\u00E1ndez";
